...
var txtRecordToObject = require('./txtrecord_to_object').txtRecordToObject;
// var counter = 0;
var internal = {};

console.log("txtRecordToObject =", txtRecordToObject);
  ...
  function addService(servByAddr, service, addr)
  {
    ...
    if (servByAddr.hasOwnProperty(fullname)) {
      ...
      servByFullName = servByAddr[fullname] = {name:service.fullname,
                                                port:service.port,
                                                type:service.type,
                                                txtStrings:service.txt,
                                                txtRecord:txtRecordToObject(service.txt),
                                                address:addr,
                                                host:service.host};
    ...
    if (isNew) {
       ...
       * @property {array}  txtStrings - Array of strings containing the TXT data
       * @property {object} txtRecord - Objects created from txtStrings
       */
